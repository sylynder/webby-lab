...
class Base_Profiler extends \CI_Profiler
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->_ci_cached_vars = ci()->load->_ci_cached_vars;
    }
    ...
    protected function _compile_eloquent()
    {
        ...
        if (file_exists(APPPATH . '/models/Eloquent/Assets/Action.php')) {
            ci()->load->model('Eloquent/Assets/Action');
        }
    ...
    function _compile_userdata()
    {
        ...
        if (false !== ci()->load->is_loaded('session')) {
    ...
    public function run()
    {
        ...
        return ci()->load->view('profiler_template', ['sections' => $this->_sections], true);
    }
}
