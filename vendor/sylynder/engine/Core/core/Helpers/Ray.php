...
*/
     ...
     * @return  Ray      $this
     */
    private function setWorkingArray(array $working_array): \Base\Helpers\Ray
    {
     ...
     * @return  Ray      $this
     */
    public function with(array $working_array): \Base\Helpers\Ray
    {
        $this->flush();
     ...
     * @return  Ray      $this
     */
    public function flush(): \Base\Helpers\Ray
    {
...
*/
     ...
     * @return  Ray     $this
     */
    public function sortByValues(): \Base\Helpers\Ray
    {
     ...
     * @return  Ray     $this
     */
    public function sortByKeys(): \Base\Helpers\Ray
    {
     ...
     * @return  Ray     $this
     */
    public function values(): \Base\Helpers\Ray
    {
     ...
     * @return  Ray     $this
     */
    public function except(array $except_key): \Base\Helpers\Ray
    {
     ...
     * @return  Ray     $this
     */
    public function only(array $only_key): \Base\Helpers\Ray
    {
     ...
     * @return  Ray     $this
     */
    public function unique(?string $unique_key = null): \Base\Helpers\Ray
    {
        $unique_array = [];
        $temp_array = [];
     ...
     * @return  Ray     $this
     */
    public function groupBy(string $group_by_key): \Base\Helpers\Ray
    {
        $keyed_array = [];
     ...
     * @return  Ray         $this
     */
    public function column(string $column_key, ?string $column_key_by = null): \Base\Helpers\Ray
    {
        $column_array = [];
     ...
     * @return  Ray         $this
     */
    public function where(string $where_key, string $where_value): \Base\Helpers\Ray
    {
        $where_array = [];
     ...
     * @return  Ray         $this
     */
    public function whereIn(string $where_key, array $where_values): \Base\Helpers\Ray
    {
        $where_array = [];
     ...
     * @return  Ray         $this
     */
    public function whereNot(string $where_key, string $where_value): \Base\Helpers\Ray
    {
        $where_array = [];
     ...
     * @return  Ray         $this
     */
    public function whereNotIn(string $where_key, array $where_values): \Base\Helpers\Ray
    {
        $where_array = [];
     ...
     * @return  Ray         $this
     */
    public function filter(callable $filter_callable): \Base\Helpers\Ray
    {
