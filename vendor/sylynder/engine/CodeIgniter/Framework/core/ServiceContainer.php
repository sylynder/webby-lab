...
/**
 * Simple Service Container for CodeIgniter 3
 * Provides modern dependency injection while maintaining CI3 compatibility
 */
class CI_ServiceContainer
{
    ...
    public function has(string $abstract): bool
    {
        return isset($this->bindings[$abstract]) || 
               ...
               $this->canResolveFromCI3($abstract);
    }
    ...
    /**
     * Check if can resolve from CI3 ecosystem
     * 
     * @param string $abstract
     * @return bool
     */
    protected function canResolveFromCI3(string $abstract): bool
    {
    ...
    protected function isLibrary(string $name): bool
    {
        ...
        return file_exists($libraryPath) || file_exists($systemLibraryPath);
    }
    ...
    protected function isHelper(string $name): bool
    {
        ...
        return file_exists($helperPath) || file_exists($systemHelperPath);
    }
