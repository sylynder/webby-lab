                                ...
                                <div class="wgs wgs-text">
                                    <div class="wgs-body">
                                        <a href="./" class="wgs-logo">
                                            <img src="assets/website/images/logo-full-white.png" srcset="assets/website/images/logo-full-white2x.png 2x" alt="logo">
                                        </a>
                                        <p>Copyright © 2020 Trading. <br> All rights reserved. </p>
                                        <p class="copyright-text">Developed by <a href="#">Developer Kwame</a></p>
                                    </div>
                                </div>
                            </div><!-- .col -->
