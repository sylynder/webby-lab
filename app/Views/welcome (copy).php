...
<body class="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center p-4">
    <div class="max-w-4xl w-full text-center">
        ...
        <p class="text-xl md:text-2xl text-gray-300 mb-8">
            The lightweight, modern PHP framework for building amazing web applications
        </p>
...
<span class="text-gray-400">Press Ctrl+C to stop the server</span></pre>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <a href="#" class="px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition-all transform hover:scale-105">
                <i class="fas fa-download mr-2"></i> Download
            </a>
            <a href="#" class="px-6 py-3 bg-pink-600 hover:bg-pink-700 rounded-lg font-medium transition-all transform hover:scale-105">
        ...
        <div class="text-gray-500 text-sm">
            <p>Webby PHP Framework v1.0.0</p>
            <p class="mt-2">© 2023 Webby Team. All rights reserved.</p>
        </div>
    </div>
