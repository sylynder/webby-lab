                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <div class="border_preview">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $coininfo->pair_with; ?> <?php echo $data->amount;?></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="text-right">
                                <button type="button" onclick="transfer('<?php echo $v->id;?>');" class="btn btn-success w-md m-b-5">Confirm</button>
        ...
        $.ajax({
            ...
            success: function(data) { 
                ...
                if(data!=''){
                    ...
                    window.location.href = "<?php echo base_url('customer/transfer/transfer_details/').$this->uri->segment(4); ?>";
