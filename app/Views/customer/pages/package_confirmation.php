    ...
    <div class="col-sm-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-footer text-right">
                <a id="confirm_order" href="<?php echo base_url('customer/package/buy/').$package->package_id;?>" class="btn btn-success"> Confirm</a>
...
<script type="text/javascript">
    ...
    var package = <?php echo $menucontrol->package;?>

    if(package==0){

        $('#confirm_order').removeClass('btn-success');
        $('#confirm_order').css('cursor','not-allowed');
        $('#confirm_order').addClass('btn-default');
    }
