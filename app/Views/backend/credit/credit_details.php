            ...
            <div class="panel-body"  id="printableArea">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <address>
                            <strong><?php echo @$credit_info->first_name.' '.@$credit_info->last_name;?></strong><br>
                    ...
                    <table class="table table-border table-bordered ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $coininfo->pair_with; ?> <?php echo @$credit_info->amount;?></td>
                                <td><?php echo @$credit_info->deposit_date;?></td>
                                <td><?php echo @$credit_info->comment;?></td>
                            </tr>
