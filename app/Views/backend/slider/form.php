            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', $slider->id) ?> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="slider_h1_en" value="<?php echo esc($slider->slider_h1_en); ?>" class="form-control" type="text" id="slider_h1_en">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="slider_h2_en" value="<?php echo esc($slider->slider_h2_en); ?>" class="form-control" type="text" id="slider_h2_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="slider_h2_fr" class="col-sm-4 col-form-label"><?php echo display('slider_h2')." ".$web_language->name ?></label>
                        <div class="col-sm-8">
                            <input name="slider_h2_fr" value="<?php echo esc($slider->slider_h2_fr); ?>" class="form-control" type="text" id="slider_h2_fr">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="slider_h3_en" class="col-sm-4 col-form-label"><?php echo display('slider_h3_en') ?></label>
                        <div class="col-sm-8">
                            <input name="slider_h3_en" value="<?php echo esc($slider->slider_h3_en); ?>" class="form-control" type="text" id="slider_h3_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="slider_h3_fr" class="col-sm-4 col-form-label"><?php echo display('slider_h3')." ".$web_language->name ?></label>
                        <div class="col-sm-8">
                            <input name="slider_h3_fr" value="<?php echo esc($slider->slider_h3_fr); ?>" class="form-control" type="text" id="slider_h3_fr">
                        </div>
                    </div>
                    <div class="form-group row">
