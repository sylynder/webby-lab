            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="article1_en" class="form-control editor" placeholder="<?php echo display('short_description_en') ?>" type="text" id="article1_en"><?php echo esc($article->article1_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('short_description')." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <textarea name="article1_fr" class="form-control" placeholder="<?php echo display('short_description')." ".$web_language->name ?>" type="text" id="article1_fr"><?php echo esc($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label"><?php echo display('long_description_en') ?></label>
                        <div class="col-sm-10">
                            <textarea  id="summernote" name="article2_en" class="form-control editor" placeholder="<?php echo display('long_description_en') ?>" type="text" id="article2_en"><?php echo esc($article->article2_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label"><?php echo display('long_description')." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <textarea   id="summernote1" name="article2_fr" class="form-control" placeholder="<?php echo display('long_description')." ".$web_language->name ?>" type="text" id="article2_fr"><?php echo esc($article->article2_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="row">
