            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="headline_en" value="<?php echo esc($article->headline_en) ?>" class="form-control" placeholder="<?php echo display('question_en') ?>" type="text" id="headline_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label"><?php echo display('question')." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <input name="headline_fr" value="<?php echo esc($article->headline_fr) ?>" class="form-control" placeholder="<?php echo display('question')." ".$web_language->name ?>" type="text" id="headline_fr">
                        </div>
                    </div>
                    <div class="form-group row">
