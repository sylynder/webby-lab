            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="article1_en" class="form-control editor" placeholder="<?php echo display('info') ?>" type="text" id="article1_en"><?php echo esc($article->article1_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label"><?php echo display('quote') ?></label>
                        <div class="col-sm-10">
                            <textarea name="article2_en" class="form-control" placeholder="<?php echo display('quote') ?>" type="text" id="article2_en"><?php echo esc($article->article2_en) ?></textarea>
                        </div>
                    </div>
                    <div class="row">
