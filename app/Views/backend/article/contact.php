            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', @$article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="headline_fr" value="<?php echo esc(@$article->headline_fr)." ".@$web_language->name ?>" class="form-control" placeholder="<?php echo display('headline_fr') ?>" type="text" id="headline_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_en" class="col-sm-2 col-form-label"><?php echo display('address') ?></label>
                        <div class="col-sm-10">
                            <textarea name="article1_en" class="form-control editor" placeholder="<?php echo display('address') ?>" type="text" id="article1_en"><?php echo esc(@$article->article1_en) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('phone') ?></label>
                        <div class="col-sm-10">
                            <textarea id="summernote" name="article1_fr" class="form-control editor" placeholder="<?php echo display('phone') ?>" type="text" id="article1_fr"><?php echo esc(@$article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label"><?php echo display('office_time') ?></label>
                        <div class="col-sm-10">
                            <textarea id="summernote1" name="article2_en" class="form-control editor" placeholder="<?php echo display('office_time') ?>" type="text" id="article2_en"><?php echo esc(@$article->article2_en) ?></textarea>
                        </div>
                    </div>
                    <div class="row">
