            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="" style="margin: 0px 0px 10px 0px;background: #bd9900;padding: 10px;color: #fff;border: 2px dashed #000;">
                            <h2>Payout Cronjob</h2>
                            <div class="input-group">
                                    <input type="text" class="form-control" id="copyed" value="curl --request GET <?php echo base_url('customer/auto_commission/payout/');?>" readonly>
