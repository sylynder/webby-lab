            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('id', $advertisement->id) ?> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="name" value="<?php echo esc($advertisement->name); ?>" class="form-control" type="text" id="name" placeholder="<?php echo display('name') ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <span id="add_content_load">
                        ...
                        <div class='form-group row'>
                            ...
                            <div class='col-sm-8'>
                                <textarea  name='script' class='form-control' placeholder='<?php echo display('embed_code') ?>' type='text' id='script'><?php echo esc($advertisement->script) ?></textarea>
                            </div>
                        </div>
                        <?php } ?>
