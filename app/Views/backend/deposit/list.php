                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $coininfo->pair_with." ".$value->amount; ?></td>
                            <td><?php echo $value->method; ?></td>
                            <td><?php echo $coininfo->pair_with." ".$value->fees_amount; ?></td>
                            <td>
                                <?php
                            ...
                            <?php } else { ?>
                            <td width="150px">
                                <a href="<?php echo base_url()?>backend/deposit/deposit/confirm_deposit?id=<?php echo $value->id;?>&user_id=<?php echo $value->user_id;?>&set_status=1" class="btn btn-success btn-sm"><?php echo display('confirm')?></a>
                                <a href="<?php echo base_url()?>backend/deposit/deposit/cancel_deposit?id=<?php echo $value->id;?>&user_id=<?php echo $value->user_id;?>&set_status=2?>" class="btn btn-danger btn-sm"><?php echo display('cancel')?></a>
                            </td>
                           <?php } ?>
                        </tr>
                        <?php } ?>  
