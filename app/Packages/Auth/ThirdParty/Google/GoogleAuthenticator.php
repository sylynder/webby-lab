...
namespace App\Packages\Auth\ThirdParty\Google;
...
class GoogleAuthenticator
{
    ...
    /**
     * Check if the code is correct. This will accept 
     * codes starting from $discrepancy*30sec ago 
     ...
     * for decoding from/encoding to base32
     *
     * @return array
     */
