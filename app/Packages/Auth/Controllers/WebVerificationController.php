...
class WebVerificationController extends WebController
{
    // User Verify View
    private $verifyView = 'Auth.users.register';

    // User Verify Routes
    private $verifySuccessRoute = 'register';
    private $verifyFailureRoute = 'register';

    private $defaultIndex = 'verification';
