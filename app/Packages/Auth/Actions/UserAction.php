...
class UserAction extends Action
{
    ...
    public function uploadProfileImage($image, $userId, $isStaff = false)
    {
        ...
        if ($image['name'] !== "") {
            ...
            $this->editUser($user, $source, $userId);
     ...
     * @return mixed
     */
    public function createUser($data, $userTable, $userId)
    {
        ...
        if ($userTable == $this->staff || $userTable == $this->admin) {
            $data = add_associative_array($data, 'created_by', $userId);
        }
     ...
     * @return mixed
     */
    public function editUser($data, $userTable, $userId)
    {
        ...
        if ($userTable == $this->staff || $userTable == $this->admin) {
            $data = add_associative_array($data, 'updated_by', $userId);
        }
     ...
     * @return bool
     */
    public function deleteUser($userId, $deletedBy, $softDelete = true)
    {
