...
<body class='pace-top'>
	...
	<div id="app" class="app">
		...
		<div class="login login-with-news-feed">
			<!-- BEGIN news-feed -->
			<div class="news-feed">
				<div class="news-image" style="background-image: url(<?=img()?>bend/img/login-bg.jpg)"></div>
				<div class="news-caption">
					<h4 class="caption-title"><b>{{config('app_name')}}</b> Admin</h4>
					<p>
						Supervise Backend ™.
					</p>
				</div>
			...
			<div class="login-container">
					...
					<div class="brand">
						<div class="d-flex align-items-center">
							<a href="{{ url(current_route()) }}">
								<img width="80%" src="{{ img('images/logo-dark.png') }}" alt="{{config('app_name')}} Logo" width="60%">
							</a>
						</div>
						<small> Administrator's Portal </small>
					</div>
					<div class="icon">
				...
				<div class="login-content">
					...
					<form class="fs-13px" action="{{url('admin-panel.login')}}" method="post" autocomplete="off">

						<div class="form-floating mb-15px">
							<input type="text" class="form-control h-45px fs-13px" placeholder="Email Address" name="user_id" id="user_id" />
							<label for="user_id" class="text-gray-600 d-flex align-items-center fs-13px">Email Address</label>
						...
						<div class="form-floating mb-15px">
							...
							<label for="password" class="text-gray-600 d-flex align-items-center fs-13px">Password</label>
						...
						<div class="mb-0 text-center text-gray-600 text-gray-500-darker">
