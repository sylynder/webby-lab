...
<body>
    ...
    <div class="container-fluid" >
        ...
        <pre class="logs" style="margin-bottom: 50px; font-size:smaller; height:100%">
                <h1 style="text-align: center; margin-top: 200px;margin-bottom: 200px;">Sorry, No Logs Found <?=($date == today()) ? ' Today' : 'On ' .format_date('jS F, Y', $date)?> </h1>
        </pre>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6" style="text-align: right;padding-top: 7px;">
                    <div class="btn btn-default btn-xs" onclick="javascript:window.history.go(-1)">Go Back</div> |
    ...
    <script>
        function clearLogs() {
            alert("Sorry logs cannot be cleared for now");
        }
    </script>
</body>
