...
<style type="text/css">
	.bottom-right{position:fixed;bottom:0;right:0;cursor:pointer;background-color:#DD4814;height:50px; margin-bottom:1px;}.right{right:0}#codeigniter_profiler{display:none;position:fixed;padding:0;bottom:0;right:0;height:270px;overflow:scroll;width:100%;z-index:2000}.debugger_header{width:100%;position:fixed;background-color:#faebd7}.nav-tabs>li>a{text-decoration:none}
</style>
...
<!--debugger -->
<div id="debugger_header" style="display:none">
	<div class="debugger_header">
		<ul class="nav nav-tabs">
			...
			<li class="pull-right header" onclick="debugger_status();"><a style="color:red;" href="#" class="text-muted">

<img src=" data:image/png;base64,"/></a></li>
		</ul>
	</div>
</div>
...
<script>
	...
	jQuery(document).ready(function() {
		...
		debugger_header = $('#debugger_header').html();
	...
	function create_debugger() {
		...
		$('#codeigniter_profiler').prepend(debugger_header);
